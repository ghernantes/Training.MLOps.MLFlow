...
- [3_MLflow_Tracking_Server_in_Docker](./3_MLflow_Tracking_Server_in_Docker/README.md)
    ...
    - [1. Introduction](./3_MLflow_Tracking_Server_in_Docker/README.md#1-introduction)
        - [1.1 Scenarios 3 and 3b](./3_MLflow_Tracking_Server_in_Docker/README.md#11-scenarios-3-y-3b)
    ...
    - [2. Building a basic Docker image for MLflow](./3_MLflow_Tracking_Server_in_Docker/README.md#2-building-a-basic-docker-image-for-mlflow)
    ...
    - [4. Creating a Docker stack for MLflow](./3_MLflow_Tracking_Server_in_Docker/README.md#4-creating-a-docker-stack-for-mlflow)
    ...
    - [6. Building a non-root Docker image for MLflow and installing depencies with conda](./3_MLflow_Tracking_Server_in_Docker/README.md#6-building-a-non-root-docker-image-for-mlflow-and-installing-depencies-with-conda)
